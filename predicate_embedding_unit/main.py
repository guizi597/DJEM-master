...
if __name__ == '__main__':
    ...
    if HYBRID:
        print("training predicate embedding...")
    ...
    predicate_embd, J = training(output_layer, loss, 25, Config.epochs, train, e, Config.k, test)
    get_hits(predicate_embd, test)
    with open(Config.ckpt+"/%s_predicate_embd.pkl"%Config.language, "wb") as f:
        pickle.dump(predicate_embd, f)
