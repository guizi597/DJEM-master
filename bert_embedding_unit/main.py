...
def fixed(seed):
    """
    Fixed random number seed, convenient for next reproduction
    """
    random.seed(seed)  #
...
def main():
    ...
    if RANDOM_DIVIDE_ILL:
        # get train/test ILLs by random divide all entity ILLs
